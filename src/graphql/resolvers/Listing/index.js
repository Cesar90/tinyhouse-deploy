...
const verifyHostListingInput = ({ title, description, type, price }) => {
    if (title.length > 100) {
        throw new Error("Listing title must be unde 100 characteres");
    }
    if (description.length > 5000) {
        throw new Error("Listing description must be under 5000 characteres");
    }
...
exports.listingResolvers = {
            ...
            try {
                ...
                if (location) {
                    ...
                    if (country) {
                        ...
                        throw new Error("no contry found");
                    }
    ...
    Mutation: {
        hostListing: (__root, { input }, { db, req }) => __awaiter(void 0, void 0, void 0, function* () {
