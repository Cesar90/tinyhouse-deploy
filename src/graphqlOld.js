...
const Listings = new graphql_1.GraphQLObjectType({
    name: "Listing",
    fields: {
...
const query = new graphql_1.GraphQLObjectType({
    ...
    fields: {
        listings: {
            type: graphql_1.GraphQLNonNull(graphql_1.GraphQLList(graphql_1.GraphQLNonNull(Listings))),
            resolve: () => {
...
const mutation = new graphql_1.GraphQLObjectType({
    ...
    fields: {
        deleteListing: {
            type: graphql_1.GraphQLNonNull(Listings),
            args: {
                id: {
